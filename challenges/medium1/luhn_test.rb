...
# addends method returns an array containing the transformed numbers - every second digit doubled.
# addends - for any digits that become 10 or more, subtract 9 from the result.
